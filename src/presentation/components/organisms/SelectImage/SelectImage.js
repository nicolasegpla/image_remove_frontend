...
import { InputSelectImage } from '@/presentation/components/atoms';
...
export function SelectImage() {
    ...
    return (_jsx(FormSelectImage, { children: _jsx(InputSelectImage, { handleClick: handleClick, onChange: handleFileChange, filename: selectedFile?.name || '', errorFile: errorFile }) }));
}
